...
export default class AllProductListContainer extends Component {
  constructor(props) {
    super(props);

    this.state = {
      productQty: 1,
      isPress: this.props.compareData,
      loading: false,
    };
  }
  ...
  async EditOrder() {
    ...
    POST('edit/order', raw)
      .then(async response => {
        console.log('order mode createResponse ', response);
        this.props.isLoading(false);
  ...
  conditionss() {
    ...
    if (this.state.loading == false) {
      if (this.props.editMode || this.props.cartData.length != 0) {
      ...
      } else if (this.props.createApicl) {
        this.CreateOrder();
      }
    }
  }
        ...
        {this.state.isPress ? (
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              this.conditionss();
              // if (this.state.loading == false) {
              //   this.props.editMode || this.props.cartData.length != 0
              //     ? this.EditOrder()
              //     : this.CreateOrder();
              // }
            }}>
